...
Use `--version 3.1.10` for a specific release or `--install-dir <DIRECTORY>` for another
...
Add `-Version 3.1.10` or `-InstallDir <DIRECTORY>` after the script path. The process-scoped
